...
import com.blabla.documentsui.dirlist.AccessibilityEventRouter;
 ...
 */
public final class HorizontalBreadcrumb extends RecyclerView implements NavigationViewManager.Breadcrumb {
    ...
    @Override
    public void setup(NavigationViewManager.Environment env,
                      com.blabla.documentsui.base.State state,
    ...
    private static final class BreadcrumbAdapter
            extends Adapter<BreadcrumbHolder> {

        private final NavigationViewManager.Environment mEnv;
        private final com.blabla.documentsui.base.State mState;
        private final OnKeyListener mClickListener;
        // We keep the old item size so the breadcrumb will only re-render views that are necessary
        private int mLastItemSize;

        public BreadcrumbAdapter(com.blabla.documentsui.base.State state,
                                 NavigationViewManager.Environment env,
                                 OnKeyListener clickListener) {
            mState = state;
            mEnv = env;
