...
import com.blabla.documentsui.base.DebugHelper;
...
public class Injector<T extends ActionHandler> {
    ...
    public final ActionModeController getActionModeController(
            MenuManager.SelectionDetails selectionDetails, EventHandler<MenuItem> menuItemClicker) {
     ...
     *            called from {@link RootsFragment}.
