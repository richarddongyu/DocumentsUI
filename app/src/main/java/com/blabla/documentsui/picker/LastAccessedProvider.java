...
import com.blabla.documentsui.base.DurableUtils;
...
public class LastAccessedProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.blabla.documentsui.lastAccessed";
            ...
            while (cursor.moveToNext()) {
                try {
                    ...
                    if (stack.getRoot() != null && predicate.test(stack.getRoot().authority)) {
                        final String packageName = DocumentInfo.getCursorString(
