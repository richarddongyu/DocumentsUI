...
public class PickFragment extends Fragment {
    ...
    private @FileOperationService.OpType int mCopyOperationSubType = FileOperationService.OPERATION_UNKNOWN;
     ...
     */
    public void setPickTarget(int action, @FileOperationService.OpType int copyOperationSubType,
            boolean restrictScopeStorage, DocumentInfo pickTarget) {
        assert(copyOperationSubType != FileOperationService.OPERATION_DELETE);
