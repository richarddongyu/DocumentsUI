...
import com.blabla.documentsui.dirlist.IconHelper;
...
public interface DragAndDropManager {
    ...
    class RuntimeDragAndDropManager implements DragAndDropManager {
        ...
        public @State int updateState(
            ...
            @State int state;
            final @FileOperationService.OpType int opType = calculateOpType(mClipData, destRoot);
            switch (opType) {
        ...
        public boolean drop(ClipData clipData, Object localState, RootInfo destRoot,
            ...
            final @FileOperationService.OpType int opType = calculateOpType(clipData, destRoot);
        ...
        private void dropChecked(ClipData clipData, Object localState, DocumentStack dstStack,
                                 @FileOperationService.OpType int opType, FileOperations.Callback callback) {
        ...
        private @FileOperationService.OpType int calculateOpType(ClipData clipData, RootInfo destRoot) {
            if (mMustBeCopied) {
