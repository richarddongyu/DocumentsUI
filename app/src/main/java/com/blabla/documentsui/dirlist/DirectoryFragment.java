...
import static com.blabla.documentsui.base.State.MODE_GRID;
import static com.blabla.documentsui.base.State.MODE_LIST;
...
import com.blabla.documentsui.ContentLock;
import com.blabla.documentsui.DocsSelectionHelper.DocDetailsLookup;
...
import com.blabla.documentsui.Injector.ContentScoped;
...
import com.blabla.documentsui.ThumbnailCache;
import com.blabla.documentsui.TimeoutTask;
...
import com.blabla.documentsui.clipping.ClipStore;
...
import com.blabla.documentsui.picker.PickActivity;
import com.blabla.documentsui.services.FileOperation;
import com.blabla.documentsui.services.FileOperationService;
import com.blabla.documentsui.services.FileOperations;
import com.blabla.documentsui.sorting.SortDimension;
...
public class DirectoryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private boolean handleMenuItemClick(MenuItem item) {
        ...
        if (id == R.id.action_menu_select
                || id == R.id.dir_menu_open) {
            openDocuments(selection);
            mActionModeController.finishActionMode();
            return true;
        } else if (id == R.id.action_menu_open_with
                || id == R.id.dir_menu_open_with) {
...
//        }
    ...
    private void transferDocuments(
            ...
            final @FileOperationService.OpType int mode) {
        if (selected.isEmpty()) {
            return;
        }
    ...
    private @Nullable String getModelId(View view) {
        ...
        if (itemView != null) {
            ViewHolder vh = mRecView.getChildViewHolder(itemView);
    ...
    private @Nullable DocumentHolder getDocumentHolder(View v) {
        ViewHolder vh = mRecView.getChildViewHolder(v);
        if (vh instanceof DocumentHolder) {
