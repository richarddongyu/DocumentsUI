...
public final class FileOperations {
    ...
    public static void cancel(Activity activity, String jobId) {
        ...
        intent.putExtra(FileOperationService.EXTRA_JOB_ID, jobId);
    ...
    public static Intent createBaseIntent(
        ...
        intent.putExtra(FileOperationService.EXTRA_JOB_ID, jobId);
        intent.putExtra(FileOperationService.EXTRA_OPERATION, operation);
    ...
    public interface Callback {
         ...
         * @param opType file operation type {@link FileOperationService.OpType}.
         * @param docCount number of documents operated.
         */
        void onOperationResult(@Status int status, @FileOperationService.OpType int opType, int docCount);
    }
}
