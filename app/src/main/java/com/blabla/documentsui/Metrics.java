...
import com.blabla.documentsui.files.LauncherActivity;
import com.blabla.documentsui.picker.PickResult;
...
//                MetricConsts.MIME_UNKNOWN, sanitizeRoot(rootUri));
     ...
     * taps on a root in {@link RootsFragment}.
     * @param scope
     * @param info
     */
...
//                MetricConsts.PICKER_SCOPE, sanitizeRoot(info));
    ...
    public static void logFileOperation(
            @FileOperationService.OpType int operationType,
    ...
    public static void logFileOperated(
            @FileOperationService.OpType int operationType, @MetricConsts.FileOpMode int approach) {
...
//                MetricConsts.PROVIDER_SYSTEM, MetricConsts.FILEOP_RENAME);
     ...
     * @param failedFiles
     */
    public static void logFileOperationErrors(@FileOperationService.OpType int operationType,
...
//                MetricConsts.PROVIDER_SYSTEM, MetricConsts.FILEOP_RENAME_ERROR);
     ...
     * @param operationType
     */
    public static void logFileOperationCancelled(@FileOperationService.OpType int operationType) {
//        DocumentsStatsLog.write(
...
//                    providerType, getOpCode(operationType, opProviderType));
    ...
    private static void logIntraProviderFileOps(String authority, @FileOperationService.OpType int operationType) {
...
//        DocumentsStatsLog.write(DocumentsStatsLog.DOCS_UI_FILE_OP_FAILURE, authority, subFileOp);
    ...
    private static @MetricConsts.FileOp int getOpCode(
            @FileOperationService.OpType int operation, @MetricConsts.Provider int providerType) {
        switch (operation) {
            case FileOperationService.OPERATION_COPY:
                switch (providerType) {
     ...
     */
    private static @MetricConsts.FileOp int toMetricsOpType(@FileOperationService.OpType int operation) {
        switch (operation) {
            case FileOperationService.OPERATION_COPY:
