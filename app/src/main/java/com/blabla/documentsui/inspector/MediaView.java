...
public class MediaView extends TableView implements InspectorController.MediaDisplay {
    ...
    @VisibleForTesting
    public static void showAudioData(InspectorController.TableDisplay table, Bundle tags) {
    ...
    public static void showVideoData(
            InspectorController.TableDisplay table,
            Resources resources,
            DocumentInfo doc,
            Bundle tags,
    ...
    private void getAddress(float[] coords) {
        new AsyncTask<Float, Void, Address>() {
            ...
            protected void onPostExecute(@Nullable Address address) {
                if (address != null) {
                    InspectorController.TableDisplay table = MediaView.this;
     ...
     * @param tags
     */
    private static void addDimensionsRow(InspectorController.TableDisplay table, Resources resources, Bundle tags) {
