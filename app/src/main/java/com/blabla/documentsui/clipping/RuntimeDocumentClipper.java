...
package com.blabla.documentsui.clipping;
...
final class RuntimeDocumentClipper implements DocumentClipper {
    ...
    public ClipData getClipDataForDocuments(
        Function<String, Uri> uriBuilder, Selection<String> selection, @FileOperationService.OpType int opType) {
    ...
    @Override
    public ClipData getClipDataForDocuments(
            List<Uri> uris, @FileOperationService.OpType int opType, DocumentInfo parent) {
    ...
    @Override
    public ClipData getClipDataForDocuments(List<Uri> uris, @FileOperationService.OpType int opType) {
     ...
     */
    private ClipData createStandardClipData(List<Uri> uris, @FileOperationService.OpType int opType) {
     ...
     */
    private ClipData createJumboClipData(List<Uri> uris, @FileOperationService.OpType int opType) {
    ...
    public void copyFromClipData(
        ...
        @FileOperationService.OpType int opType = getOpType(bundle);
        try {
    ...
    private @FileOperationService.OpType int getOpType(ClipData data) {
        PersistableBundle bundle = data.getDescription().getExtras();
        return getOpType(bundle);
    }

    private @FileOperationService.OpType int getOpType(PersistableBundle bundle) {
