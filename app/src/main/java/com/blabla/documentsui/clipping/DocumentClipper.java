...
public interface DocumentClipper {
     ...
     */
    ClipData getClipDataForDocuments(List<Uri> uris, @FileOperationService.OpType int opType, DocumentInfo parent);

    /**
     * Returns {@link ClipData} representing the list of {@link Uri}, or null if the list is empty.
     */
    ClipData getClipDataForDocuments(List<Uri> uris, @FileOperationService.OpType int opType);
