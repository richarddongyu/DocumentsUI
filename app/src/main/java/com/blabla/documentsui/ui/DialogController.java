...
import com.blabla.documentsui.picker.ConfirmFragment;
...
import com.blabla.documentsui.services.FileOperations.Callback.Status;
...
public interface DialogController {
    ...
    public static final class RuntimeDialogController implements DialogController {
        ...
        @Override
        public void showFileOperationStatus(@Status int status, @FileOperationService.OpType int opType, int docCount) {
        ...
        private boolean shouldShowProgressDialogForOperation(@FileOperationService.OpType int opType) {
